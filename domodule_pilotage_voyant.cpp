...
void Domodule_Pilotage_Voyant::setConfigModule(const Class_ConfigModuleVoyant &i_m_configModuleVoyant)
{
  m_TimerBlink.Init(Domodule_Pilotage_Voyant::triggerSuperTimer, i_m_configModuleVoyant.Mini_Periode,
      i_m_configModuleVoyant.Nbre_Mini_Periodes, i_m_configModuleVoyant.Periode, true, this, NULL);
