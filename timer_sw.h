...
{
    Periodic_Timer = true,
    One_Shot_Timer = false
};

#ifndef TimerTime_t
typedef unsigned long long TimerTime_t;
#endif
...
public:
  TimerEvent_t(void (*Callback_Fct)(uint32_t, void*), TimerTime_t remainingTime, bool Perodic, void *ArgCallBack = NULL,
    ...
    virtual void Init(void (* Callback_Fct)(uint32_t, void*), TimerTime_t remainingTime, bool Perodic, void * ArgCallBack=NULL, const char Label[]=NULL);
